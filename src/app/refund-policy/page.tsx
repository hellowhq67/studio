    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <Card>
        ...
        <CardContent className="prose max-w-none text-muted-foreground">
          ...
          <p>To initiate a refund, please contact our customer service team at support@glowup.com with your order number and a reason for the return. We will provide you with instructions on how to send back the returned products.</p>

          <h2>4. Shipping Charges</h2>
          <p>Shipping charges incurred in connection with the return of a product are non-refundable. You are responsible for paying the costs of shipping and for the risk of loss of or damage to the product during shipping, both to and from GlowUp.</p>
          ...
          <h2>6. Contact Us</h2>
          <p>If you have any questions about our Refund Policy, please contact us at support@glowup.com.</p>
        </CardContent>
      </Card>
    </div>
  );
